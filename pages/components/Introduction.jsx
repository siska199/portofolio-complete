    ...
    <Section id="introduction">
      <div className='flex flex-col text-center my-auto justify-center items-center gap-5 sm:w-3/4 lg:w-1/2 mx-auto'>
          ...
          <Link href="https://wa.me/6283111962313">
            <a target="_blank" className='mt-4 font-bold bg-slate-500 hover:bg-slate-700 text-slate-200 px-3 py-2 rounded-sm flex items-center gap-2 text-sm md:text-[1rem]'> <span></span> Do you want to collaborate with me <span><AiOutlineWhatsApp/> </span> ?</a>
          </Link>
