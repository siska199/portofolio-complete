...
export const learningJourneys = [
  {
    ...
    note: ["TMS (Transportation Management System"],
  },
  {
...
export const projects = [
  {
    ...
    detailApp: `The DeweTour app is the first fullstack app I made to fulfill a task while joining dumbways bootcamp.
        ...
        `,
    linkGithub:
      "https://github.com/siska199?tab=repositories&q=dewe&type=&language=&sort=",
  ...
  },
  {
    ...
    detailApp: `Literature app is a fullstack application that i made to fulfill the final project of the dumbways bootcamp.
        ...
        `,
    linkGithub:
      "https://github.com/siska199?tab=repositories&q=literature&type=&language=&sort=",
  ...
  {
    tittle: "Clone Tiktik",
    nameApp: "clone-tiktik-199",
    imgApp: "projects/clone-tiktik/cover.PNG",
    logoApp: "projects/clone-tiktik/logo.png",
    stacks: [
      {
        name: "Next and NextAuth",
        image: "stacks/nextjs.png",
      ...
      {
        name: "Sanity",
        image: "stacks/sanity.png",
      },
    ],
    detailApp: `The clone tiktik application is an application that I made with the aim of learning the sanity cms
                    and also made with the aim of deepening my skills when using tailwind as a css framework. In this app
                    I use Next JS as the frontend framework and Nextauth as the authentication system with Google as the provider. For management
                    state in this application I use the Redux toolkit which is much easier to use than conventional redux.
                    Libraries used to help build this application include react-icons, adn react-time-ago.
        `,
    linkGithub: "https://github.com/siska199/tiktik-app",
    linkDemo: "https://tiktik199.vercel.app/",
  }
];
...
export const dataFAQs = [
  ...
  },
  {
    ...
    answears: [
      ...
      "Team yang mau mendengarkan masukan setiap anggotanya dan menghargai setiap masukan yang diberikan",
...
export const dataCommentById = {
  title: "DeweTour Website",
  comments: [...Array(10)].map((_, i) => ({
    name: `name ${i}`,
    username: `username ${i}`,
    image:
      "https://i.pinimg.com/564x/c9/12/74/c9127453cf3414d5fc8b52646ab36df2.jpg",
    comment: "very good i like this website",
  })),
};
/*
    *
